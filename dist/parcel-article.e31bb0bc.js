...
},{"./bundle-url":"node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"pages/home.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"pages/users.js":[function(require,module,exports) {
"use strict";
...
var users = function users() {
  return fetch("https://randomuser.me/api/?results=10").then(function (res) {
    return res.json();
  });
};
...
var home = function home() {
  ...
  (0, _users.users)().then(function (_ref) {
    ...
    results.forEach(function (user) {
      ...
      userDetails.classList = "user-details"; //user's name element

      var userName = document.createElement("div");
      userName.classList = "user-name";
      userName.innerHTML = "".concat(capitalize(user.name.title), " ").concat(capitalize(user.name.first), " ").concat(capitalize(user.name.last)); //assign name to user's name element
      ...
      userEmail.innerHTML = "".concat(user.email); //assign email address to user's email address element
...
app.appendChild((0, _home.home)());
document.body.appendChild(app);
},{"./pages/home":"pages/home.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/parcel-article.e31bb0bc.js.map